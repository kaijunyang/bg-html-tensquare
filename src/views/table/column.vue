...
<el-input v-model="searchMap.userid" placeholder="用户ID"></el-input></el-form-item>
  ...
  <el-table
    ...
    style="width: 100%">
          ...
          <el-table-column prop="name" label="专栏名称" width="180"></el-table-column>
          <el-table-column prop="summary" label="专栏简介" width="350"></el-table-column>
          <el-table-column prop="userid" label="用户ID" width="100"></el-table-column>
          <el-table-column prop="createtime" label="申请日期" width="150"></el-table-column>
          <el-table-column prop="checktime" label="审核日期" width="150"></el-table-column>
