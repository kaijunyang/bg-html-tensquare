    ...
    <el-table :data="list" border style="width: 100%">
      ...
      <el-table-column fixed="right" label="操作" width="100">
        <template slot-scope="scope">
          <el-button @click="handleEdit(scope.row.id)" type="text" size="small">查看</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
    ...
    <!-- <el-dialog title="编辑" :visible.sync="dialogFormVisible">
      <el-form label-width="80px">
        <el-form-item label="专栏ID">
          <el-input v-model="pojo.columnid"></el-input>
        </el-form-item>
        ...
        <el-form-item label="是否公开">
          <el-input v-model="pojo.ispublic"></el-input>
        </el-form-item>
        <el-form-item label="是否置顶">
          <el-input v-model="pojo.istop"></el-input>
        </el-form-item>
        <el-form-item label="浏览量">
          <el-input v-model="pojo.visits"></el-input>
        </el-form-item>
        <el-form-item label="点赞数">
          <el-input v-model="pojo.thumbup"></el-input>
        </el-form-item>
        <el-form-item label="评论数">
          <el-input v-model="pojo.comment"></el-input>
        </el-form-item>
        <el-form-item label="审核状态">
          <el-input v-model="pojo.state"></el-input>
        </el-form-item>
        <el-form-item label="所属频道">
          <el-input v-model="pojo.channelid"></el-input>
        </el-form-item>
