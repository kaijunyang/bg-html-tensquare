...
<el-switch v-model="searchMap.ishot" active-value="1" inactive-value="0"></el-switch></el-form-item>
  ...
  <el-table
    ...
    style="width: 100%">
          ...
          <el-table-column prop="summary" label="企业简介" width="280"></el-table-column>
          <el-table-column prop="address" label="企业地址" width="200"></el-table-column>
          <el-table-column prop="labels" label="标签列表" width="110"></el-table-column>
          <el-table-column prop="coordinate" label="坐标" width="120"></el-table-column>
