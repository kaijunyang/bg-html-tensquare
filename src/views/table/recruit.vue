  ...
  <div>
    ...
    <el-form :inline="true">
      ...
      <el-form-item label="经验要求">
        <el-input v-model="searchMap.condition" placeholder="经验要求"></el-input>
      </el-form-item>
    ...
    <el-table :data="list" border style="width: 100%">
      ...
      <el-table-column prop="jobname" label="职位名称" width="100"></el-table-column>
      <el-table-column prop="salary" label="薪资范围" width="130"></el-table-column>
      <el-table-column prop="condition" label="经验要求" width="100"></el-table-column>
      <el-table-column prop="education" label="学历要求" width="80"></el-table-column>
      <el-table-column prop="type" label="任职方式" width="120"></el-table-column>
      <el-table-column prop="address" label="办公地址" width="200"></el-table-column>
    ...
    <el-dialog title="编辑" :visible.sync="dialogFormVisible">
      <el-form label-width="80px">
        <el-form-item label="职位名称">
          <el-input v-model="pojo.jobname"></el-input>
        </el-form-item>
        <el-form-item label="薪资范围">
          <el-input v-model="pojo.salary"></el-input>
        </el-form-item>
        <el-form-item label="经验要求">
          <el-input v-model="pojo.condition"></el-input>
        </el-form-item>
        <el-form-item label="学历要求">
          <el-input v-model="pojo.education"></el-input>
        </el-form-item>
